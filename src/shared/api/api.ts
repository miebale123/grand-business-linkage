...
import {
  getAreaLabel,
  getPreferredMarketplaceArea,
  savePreferredMarketplaceArea,
} from '@/shared/api/localState'
...
export const getCurrentUser: ApiClient['getCurrentUser'] = (...args) =>
...
export const fetchPendingProducts: ApiClient['fetchPendingProducts'] = (...args) =>
  apiClient.fetchPendingProducts(...args)
export const fetchFeaturedProducts: ApiClient['fetchFeaturedProducts'] = (...args) =>
  apiClient.fetchFeaturedProducts(...args)
export const fetchProductById: ApiClient['fetchProductById'] = (...args) =>
  apiClient.fetchProductById(...args)
export const fetchMerchantById: ApiClient['fetchMerchantById'] = (...args) =>
  apiClient.fetchMerchantById(...args)
export const fetchMerchants: ApiClient['fetchMerchants'] = (...args) =>
  apiClient.fetchMerchants(...args)
...
export const createInquiry: ApiClient['createInquiry'] = (...args) =>
...
export const updateMerchantVerification: ApiClient['updateMerchantVerification'] = (...args) =>
  apiClient.updateMerchantVerification(...args)
export const uploadImage: ApiClient['uploadImage'] = (...args) => apiClient.uploadImage(...args)
